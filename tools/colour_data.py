#!/usr/bin/env python3
"""The data behind colour.html: the three cones and the rod, the map of
every colour the eye can see and the corner of it a screen can show, and
the order in which languages name colours.
...
# the receptors: k, name, peak nm, a width for the drawn bell (nm, below and above the peak), colour, count, a line
RECEPTORS = [
    ("s", "S cones, blue", 420, (22, 32), "#6ea0ff", "roughly a twentieth of the cones, and none at the very centre of gaze", "The rarest cone, tuned to violet and blue. There are so few that the eye cannot resolve fine detail in blue alone, which is why blue text on black is hard to read."),
    ("m", "M cones, green", 534, (40, 44), "#7ddc7d", "about a third of the cones", "Tuned to green, though it answers to most of the visible spectrum. Its curve lies almost on top of the L cone's; colour vision in the green-to-red range is the small difference between the two."),
    ...
    ("rod", "rods", 498, (36, 44), "#9a9a9a", "about 92 million, twenty times the cones", "The night receptors, a hundred times more sensitive than cones and blind to colour. At dusk the world goes grey, and, because rods peak in the blue-green, reds go dark first and blues last."),
]
...
POINTS = [
    ("d65", "daylight white, D65", 0.3127, 0.3290, "The white a screen aims for: average noon daylight, and the point of no hue at all. Every colour is a direction and a distance from here."),
...
# the basic colour terms in the order languages acquire them: stage, name, hex, a line
TERMS = [
    ...
    (2, "red", "#d62828", "The first hue to get a name, everywhere: the colour of blood and ripe fruit."),
    ...
    (7, "grey", "#8a8a8a", "Grey is last, or near it; some languages acquire it early and out of sequence."),
]
STAGES = {
    1: ("two terms", "dark and light", "the Dani of New Guinea: mili for dark and cool colours, mola for light and warm"),
    ...
    7: ("eight to eleven terms", "plus purple, pink, orange and grey", "English and most European languages; Russian and Greek have twelve, with two blues, light and dark, as separate basic terms; Hungarian has two reds"),
}
...
REFS = [
    ...
    (apa.article("Curcio, C. A., Sloan, K. R., Kalina, R. E., &amp; Hendrickson, A. E.", 1990, "Human photoreceptor topography", "Journal of Comparative Neurology", 292, 4, "497-523", "https://doi.org/10.1002/cne.902920402"),
     "4.6 million cones and 92 million rods in the average retina, 199,000 cones a square millimetre at the fovea."),
