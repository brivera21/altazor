...
SCRIPTS = [
    ...
    ("southarabian", "South Arabian", -900, "protosinaitic", "abjad", "Yemen", "A separate branch from the Canaanite letters, with 29 consonants in a different order, used for the kingdoms of Saba and its neighbors. It crossed the Red Sea to become the script of Ethiopia.", False),
