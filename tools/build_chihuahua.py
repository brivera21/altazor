...
HIST_CH = {
    ...
    "nations": [
        ...
        {"n": "Conchos", "src": "es.wikipedia.org/wiki/Conchos", "poly": [[-106.5, 27.3], [-104.6, 27.6], [-104.9, 29.2], [-106.3, 28.9]], "lat": 28.25, "lon": -105.5, "note": "A lo largo del río Conchos; diezmados y asimilados durante el siglo XVIII.", "after": {"y": 1750, "t": "asimilación forzada"}},
    ...
    "events": [
        ...
        {"y": 1680, "t": "rem", "n": "Rebeliones conchas", "lat": 28.7, "lon": -105.3, "note": "Décadas de levantamientos conchos y tobosos contra encomiendas y misiones.", "src": "es.wikipedia.org/wiki/Conchos"},
