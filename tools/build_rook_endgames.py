#!/usr/bin/env python3
"""Generate rook-endgames.html for the Chess section.
...
OUT = Path(__file__).parent.parent / "rook-endgames.html"
...
<title>Rook Endgames &middot; Altazor</title>
...
def main():
    ...
    print(f"rook-endgames.html  {len(data)} positions, "
