...
The centers and dates follow the domestication literature as summarized
in Larson and colleagues' 2014 review and the encyclopedias, rounded;
...
# the centers of domestication: k, name, lon, lat, years ago (a round figure), plants, animals, a line
CENTERS = [
    ...
    ("mesoamerica", "Mesoamerica", -100, 18, 9000, "maize, squash, beans, chili, avocado, cacao", "turkeys, dogs", "Maize was bred from teosinte, a grass with a dozen hard kernels, in the Balsas valley about 9,000 years ago, squash earlier, and beans by 6,000; the three sisters planted together fed every civilization from the Olmec to the Aztec, and now feed the world's cattle."),
    ...
    ("amazonia", "south-western Amazonia", -63, -12, 8000, "manioc, peanuts, sweet potatoes, cacao", "none", "The forest's own center: manioc, a root that has to be grated and squeezed of its cyanide before it can be eaten, from about 8,000 years ago, and the peanut. Manioc is now the staple of half a billion people in Africa."),
    ...
    ("ethiopia", "the Ethiopian highlands", 38, 9, None, "teff, coffee, ensete, finger millet", "none", "A center of its own with crops grown almost nowhere else: teff, the smallest grain in cultivation, the false banana ensete, and coffee, which left for Yemen and the world only in the fifteenth century."),
    ...
    ("steppe", "the Pontic steppe", 40, 48, 5000, "none", "horses", "Not a farming center but the horse's: tamed on the grasslands north of the Black Sea and the Caspian about five thousand years ago, the date still argued over, and with it came the cart, the chariot, the cavalry and half of the history since."),
]

# the world's harvest: k, name, million metric tons, year, top producer and share, what it is for, source
CROPS = [
    ("sugarcane", "sugarcane", 1920, 2022, "Brazil, 38%", "sugar, and in Brazil ethanol for cars; four fifths of it is water and fiber", "Wikipedia, Sugarcane"),
...
REFS = [
    (apa.article("Larson, G., Piperno, D. R., Allaby, R. G., Purugganan, M. D., Andersson, L., Arroyo-Kalin, M., Barton, L., Climer Vigueira, C., Denham, T., Dobney, K., Doust, A. N., Gepts, P., Gilbert, M. T. P., Gremillion, K. J., Lucas, L., Lukens, L., Marshall, F. B., Olsen, K. M., Pires, J. C., ... Fuller, D. Q.", 2014,
     ...
     "The centers of domestication and their dates, as the field saw them in 2014."),
...
REFS += [(apa.wiki(f"https://en.wikipedia.org/wiki/{p}"), a) for p, a in [
    ("Neolithic_Revolution", "The centers, crops and dates."),
    ("Domestication_of_animals", None), ("Kuk_Early_Agricultural_Site", None), ("Maize", "Teosinte and the Balsas valley; 1.16 billion metric tons in 2020."), ("Potato", None), ("Domestication_of_the_horse", None),
