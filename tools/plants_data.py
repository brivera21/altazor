...
PARTS = [
    ("root", "the roots", "Anchor the plant and draw up water and minerals through hairs a tenth of a millimeter across, of which a single rye plant was found to have fourteen billion. Nothing green happens here; roots are fed sugar from above.",
    ...
    ("stem", "the stem", "Holds the leaves up to the light and carries traffic both ways: water and minerals up through the xylem, dead tubes pulled by evaporation at the leaves, and sugar down through the phloem, living tubes pushed by pressure.",
     "water rises in a tall tree at up to a meter a minute, and the pull at the top of the tallest reaches twenty or thirty atmospheres", "Wikipedia, Xylem; Wikipedia, Phloem"),
    ("leaf", "the leaf", "A flat solar panel. Light is caught in chloroplasts in the cells beneath the surface; carbon dioxide enters through pores, the stomata, and water leaves through them, some 97 percent of all the water the roots take up.",
     "stomata: a hundred to a thousand on every square millimeter", "Wikipedia, Leaf; Wikipedia, Stoma"),
    ("flower", "the flower", "The organ of sex, built to be visited. Petals advertise; stamens make pollen; the pistil at the center receives it and grows the seeds. Most flowering plants have both sexes in one flower.",
...
CHLOROPHYLL = {
    "a": {"peaks": [(430, 22, 1.0), (662, 14, 0.8)], "color": "#9be564"},
    "b": {"peaks": [(453, 20, 0.85), (642, 16, 0.4)], "color": "#6ee7f2"},
}
...
KINDS = [
    ...
    ("conifer", "conifers and their kin", 1100, 385, "The first seeds: an embryo sealed with food, so a plant could breed without standing water and colonize the dry interior. Pines, firs, cypresses, ginkgo and the cycads, few in species but vast in numbers and size.", "Wikipedia, Gymnosperm"),
...
REFS = [
    (apa.article("Field, C. B., Behrenfeld, M. J., Randerson, J. T., &amp; Falkowski, P.", 1998, "Primary production of the biosphere: Integrating terrestrial and oceanic components",
     ...
     "The biosphere's production, 105 billion metric tons of carbon a year, split near evenly between land and sea."),
