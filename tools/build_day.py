...
Wood, E. F. (2018). Present and future K&ouml;ppen-Geiger climate classification maps
at 1-km resolution. <i>Scientific Data, 5</i>, 180214.
...
the geonamescache package. <a href="https://www.geonames.org/">https://www.geonames.org/</a></p>
<p>Meeus, J. (1998). <i>Astronomical algorithms</i> (2nd ed.). Willmann-Bell.
<a href="https://openlibrary.org/books/OL22573836M/Astronomical_algorithms">https://openlibrary.org/books/OL22573836M/Astronomical_algorithms</a></p>
...
function frame(now) {{
  ...
  last = now;
  if (runDay) jd += dt*0.3;            // one turn about every three seconds
  if (runYear) {{
