...
<p class="note">Four arrows point into thermal energy and only two lead out,
and the one back to motion pays a toll set by the two temperatures. That
one-way traffic is the second law.</p>
