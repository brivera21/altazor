...
the fiber lengths are Marner and colleagues' 2003 stereology; the energy
...
OUTSIDE = [
    ...
    ("occipital", "the occipital lobe", "A lobe", "The back of the brain, and almost entirely about seeing. The image from the eyes lands here upside down and mirrored, the left half of the world on the right, and is taken apart into edges, colors, motion and depth before being sent forward.",
...
INSIDE = [
    ("callosum", "the corpus callosum", "A bridge", "The thick band of fibers joining the two hemispheres, the largest white-matter structure in the brain. Cut it, as was once done for severe epilepsy, and the two halves can no longer tell each other what they see.",
     "about 200 million axons", "Wikipedia, Corpus callosum"),
    ("thalamus", "the thalamus", "A relay", "Two eggs of gray matter at the very center. Nearly everything the cortex receives, sight, hearing, touch, passes through here first, and the cortex talks back to it constantly; it is the switchboard of attention and of sleep.",
    ...
    ("hippocampus", "the hippocampus", "Deep in the temporal lobe", "A curled ridge on the inner wall of each temporal lobe, not on the midline but drawn here in its place. New memories of events and places are made here; without it, as in the patient H. M., nothing after the injury is kept, though old memories and skills stay.",
     "about 3 cubic centimeters each side; London taxi drivers' are larger at the back", "Wikipedia, Hippocampus; Maguire et al. 2000"),
    ("amygdala", "the amygdala", "Deep in the temporal lobe", "An almond in front of each hippocampus, drawn here in its place. It tags what is seen and heard with fear and value, and sets off the body's alarm before the cortex has finished working out what the thing is.",
     "about 1.5 cubic centimeters each side", "Wikipedia, Amygdala"),
    ("basal", "the basal ganglia", "Deep, either side of the thalamus", "Clusters of gray matter around the thalamus, drawn here in their place. They choose and start movements and habits and hold them back; their dopamine supply from the midbrain fails in Parkinson's disease.",
    ...
    ("midbrain", "the midbrain", "The brainstem", "The top of the brainstem. Reflexes of the eyes and ears live here, the pupil, the startle at a loud sound, and so does the substantia nigra, whose dopamine cells feed the basal ganglia.",
     "about 2 centimeters long", "Wikipedia, Midbrain"),
    ("pons", "the pons", "The brainstem", "The bulge below the midbrain, a bridge of fibers between the two halves of the cerebellum and a relay between cortex and cerebellum. It shares the control of breathing with the medulla and generates the dreaming stage of sleep.",
     "about 2.5 centimeters long", "Wikipedia, Pons"),
    ("medulla", "the medulla", "The brainstem", "The last part of the brain before the spinal cord. Breathing, heart rate, blood pressure, swallowing, vomiting and coughing are run from here without any need of thought; the nerve fibers from each side of the cortex cross over here to the other side of the body.",
     "about 3 centimeters long", "Wikipedia, Medulla oblongata"),
    ...
    ("cord", "the spinal cord", "The way out", "Below the medulla the brain becomes the spinal cord, a finger-thick cable running down the spine, giving off a pair of nerves at each vertebra, and doing some of its own thinking: the reflex that pulls a hand from a flame never reaches the brain first.",
     "about 45 centimeters long, a centimeter across", "Wikipedia, Spinal cord"),
]
...
GROWTH_NOTES = [
    ...
    (1, "The first year adds more mass than any other: most of it is not new neurons but their branches, and the fat sheaths growing around their fibers."),
    ...
    (11, "Growth is nearly done, but the wiring is not: the frontal lobes go on insulating their fibers into the mid twenties."),
    (20, "The peak. From here the mass holds steady for about thirty years, and the myelinated fibers begin their slow loss, about a tenth a decade."),
    (58, "Decline begins around forty-five to fifty, faster in the white matter than the gray."),
    (83, "By the mid eighties the brain has lost about a tenth of its peak mass, and about half its myelinated fiber length."),
]
...
REFS = [
    ...
    (apa.article("Marner, L., Nyengaard, J. R., Tang, Y., &amp; Pakkenberg, B.", 2003, "Marked loss of myelinated nerve fibers in the human brain with age",
     ...
     "176,000 km of myelinated fiber in a man of twenty and 149,000 in a woman, falling by about a tenth a decade to 97,200 and 82,000 at eighty."),
    ...
    (apa.article("Toro, R., Perron, M., Pike, B., Richer, L., Veillette, S., Pausova, Z., &amp; Paus, T.", 2008, "Brain size and folding of the human cerebral cortex",
     ...
     "About 0.12 square meters of cortex per hemisphere, unfolded."),
