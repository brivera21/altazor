"""Truncated ELP terms from Meeus, Astronomical Algorithms, chapter 47.
Each row is (D, M, M', F, coefficient). Longitude and distance share the
argument table; latitude has its own. E corrects the terms in M for the slow
change in Earth's eccentricity."""

# longitude, units of 1e-6 degrees; distance, units of 0.001 km
LR = [
 ...
 (4,0,-3,0,    330,         0), (2,-1,2,0,     327,    -1846),
 (0,2,1,0,    -323,         0), (1,1,-1,0,     299,        0),
 (2,0,3,0,     294,     -3812), (2,0,-1,-2,      0,    -1010),
]
# latitude, units of 1e-6 degrees
B = [
