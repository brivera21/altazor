...
<div class="tiles">
  ...
  <div class="tile"><div class="k">altitud</div>
    <div class="v" id="rAlt"></div><div class="g" id="rPend"></div></div>
  <div class="tile"><div class="k">tiempo</div>
    <div class="v" id="rTiempo"></div><div class="g" id="rVel"></div></div>
  <div class="tile"><div class="k">municipio</div>
    <div class="v" id="rMun" style="font-size:17px"></div>
    <div class="g" id="rMunSub"></div></div>
  <div class="tile"><div class="k">cerca</div>
    <div class="v" id="rCerca" style="font-size:17px"></div>
    <div class="g" id="rCercaSub"></div></div>
</div>
...
{CRUZADOS[1]}. Las casillas de arriba llevan la cuenta mientras corre.</p>
