...
STARS = [
    ...
    ("Epsilon Eridani", 5084, 0.34, "K2V", 0.82, 10.5, "main",
     "A young orange dwarf with a planet and a dust disc, a favorite of science fiction."),
    ...
    ("Mira", 3000, 8400, "M7III", 1.2, 300, "giant",
     "The first variable star recognized, swelling and shrinking over 332 days on the asymptotic giant branch, near its end. Its luminosity varies."),
...
REFS = [
    ...
    (apa.article("Iben, I.", 1967, "Stellar evolution within and off the main sequence",
                 ...
                 "https://doi.org/10.1146/annurev.aa.05.090167.003035"),
     "The shape of a star's track after the main sequence."),
    (apa.book("Kippenhahn, R., Weigert, A., &amp; Weiss, A.", 2012, "Stellar structure and evolution (2nd ed.)", "Springer",
