...
.controls button.mute { color:var(--muted); }
...
<div class="controls">
  ...
  <button class="dec" data-d="1940">1940</button>
  <button class="dec" data-d="1950">1950</button>
  <button class="dec mute" data-d="1960">1960</button>
  <button class="dec" data-d="1970">1970</button>
  <button class="dec" data-d="1980">1980</button>
  <button class="dec" data-d="1990">1990</button>
  <button class="dec" data-d="2000">2000</button>
  <button class="dec" data-d="2010">2010</button>
  <button class="dec" data-d="2020">2020</button>
...
function render(){
  ...
  document.querySelectorAll('.controls button.dec').forEach(b=>{
    const d=+b.getAttribute('data-d');
    b.classList.toggle('on', Math.abs(view.a-(d-0.5))<0.6 &&
                             Math.abs(view.b-(d+10.5))<0.6);
  });
}
...
document.querySelectorAll('.controls button.dec').forEach(b=>{
  b.onclick=()=>{const d=+b.getAttribute('data-d');
    view=clampView(d-0.5,d+10.5);render();};
});
